...
<%@ page contentType="text/html;charset=UTF-8" %>
                ...
                <div class="fieldcontain form-group ${hasErrors(bean: depositInstance, field: 'depositInterestScheme', 'has-error')} ">
                    ...
                    <div class="col-sm-8"><g:select id="depositInterestScheme" disabled="disabled" name="depositInterestScheme.id" from="${icbs.deposit.DepositInterestScheme.list()}" optionKey="id" value="${depositInstance?.depositInterestScheme?.id}" class="form-control" />
