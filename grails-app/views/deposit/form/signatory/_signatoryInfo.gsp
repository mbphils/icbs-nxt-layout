...
<legend>Other Owners/Signatories</legend>
            ...
            <div class="fieldcontain form-group ${hasErrors(bean: depositInstance, field: 'depositSignatoryRules', 'has-error')} ">
                <label class="control-label col-sm-4" for="depositSignatoryRules">
                        <g:message code="deposit.depositSignatoryRules.label" default="Sig Rules" />
                </label>
                <div class="col-sm-8"><g:select id="depositSignatoryRules" name="depositSignatoryRules.id"  from="${icbs.lov.DepositSignatoryRules.findAllByStatus(true)}" optionKey="id" optionValue ="description" value="${depositInstance?.depositSignatoryRules?.id}" class="form-control"/>
                    
				    <g:hasErrors bean="${depositInstance}" field="depositSignatoryRules">
                        <div class="controls">
                                <span class="help-block">
                                    <g:eachError bean="${depositInstance}" field="depositSignatoryRules">
                                        <g:message error="${it}" /><br/>
                                    </g:eachError>
                                </span>
                        </div>
