                ...
                <div class="action-bar card card-gray">
                    ...
                    <div class="card-body table-responsive pad">
                        ...
                        <g:form id="userShowIdx" url="[action:'show',controller:'userMaster']" ></g:form>
                            <button type="button" class="swalSample btn btn-outline-success btn-sm btn-block"  onclick="showUserWarning();"><i class="fas fa-eye"></i> View User</button>
                        <g:form id="createUserIdx" url="[action:'create',controller:'userMaster']" ></g:form>
                            <button type="button" class="swalSample btn btn-outline-success btn-sm btn-block"  onclick="createUserWarning();"><i class="fas fa-lock"></i> Lock User</button>
                        <g:form id="createUserIdx" url="[action:'create',controller:'userMaster']" ></g:form>
                            <button type="button" class="swalSample btn btn-outline-success btn-sm btn-block"  onclick="createUserWarning();"><i class="fas fa-arrows-alt"></i> Transfer User Branch</button>
                        </div>
                    </div>
                </div>
            </div>
